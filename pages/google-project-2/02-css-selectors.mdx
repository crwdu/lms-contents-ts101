...
\
HTML 요소에는 class와 유사하게, id라는 속성을 부여할 수 있습니다. 하나의 HTML 문서에서 class는 같은 class 이름을 여러 요소에게 지정해줄 수 있는 반면, id는 고유해야 합니다.\
\
즉, 하나의 HTML 문서에서 id 값은 유일해야만 합니다. **같은 id 값을 여러 요소에게 동일하게 적용해서는 안됩니다.**
