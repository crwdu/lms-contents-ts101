...
<br/>
# 이미지 슬라이더 (캐로우셀 UI) 만들기 🌠

이번에는 HTML, CSS 그리고 자바스크립트까지 더하여 더욱 동적인 프로젝트 작업을 해보겠습니다.

우리가 작업할 프로젝트는 여러 개의 이미지를 순차적으로 보여주는 이미지 슬라이더, 전문 용어로 캐로우셀 UI입니다. 인터넷에서 한번쯤 본 경험이 있으시죠?

<br/>
## 미리보기

아래 화면에서 좌우측 화살표를 클릭해보세요. 이미지가 변경되는 것을 확인하셨나요?
